            ...
            <table class="min-w-full bg-white border border-gray-200 mt-4">
                <thead class="bg-gray-300">
                    <tr>
                        ...
                        <th class="border border-gray-200 px-4 py-2">Pembeli</th>
                            ...
                            <tr>
                                @if ($detailIndex === 0)
                                    <td class="border border-gray-200 px-4 py-2"
                                        rowspan="{{ $penjualan->detailPenjualans->count() }}">{{ $rowIndex++ }}
                                    </td>
                                    <td class="border border-gray-200 px-4 py-2"
                                        rowspan="{{ $penjualan->detailPenjualans->count() }}">{{ $penjualan->tanggal_jual }}
                                    </td>
                                    <td class="border border-gray-200 px-4 py-2"
                                        rowspan="{{ $penjualan->detailPenjualans->count() }}">{{ $penjualan->pembeli }}</td>
                                @endif
                                ...
                                @if ($detailIndex === 0)
                                    <td class="border border-gray-200 px-4 py-2"
                                        rowspan="{{ $penjualan->detailPenjualans->count() }}">Rp
