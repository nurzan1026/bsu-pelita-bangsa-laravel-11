...
@section('content')
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-5 mx-10">
        <!-- Card 1: Penjualan Sampah -->
        <div class="bg-white p-6 rounded-lg shadow-lg flex items-center justify-between">
            <div class="flex flex-col gap-3 text-gray-600">
                <h2 class="text-xl font-semibold">Penjualan Sampah</h2>
                <p class="text-2xl font-bold">Rp {{ number_format($totalHargaPenjualan, 0, ',', '.') }}</p>
            </div>
        ...
        <!-- Card 2: Setoran Sampah -->
        <div class="bg-white p-6 rounded-lg shadow-lg flex items-center justify-between">
            <div class="flex flex-col gap-3 text-gray-600">
                <h2 class="text-xl font-semibold">Setoran Sampah</h2>
                <p class="text-2xl font-bold">{{ number_format($totalBeratSetoran, 2, ',', '.') }} Kg</p>
            </div>
            <div class="w-fit h-fit p-2 rounded-full bg-green-400">
                <svg class="w-8 h-8 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                    stroke="currentColor">
        ...
        <!-- Card 3: Sampah Daur Ulang -->
        <div class="bg-white p-6 rounded-lg shadow-lg flex items-center justify-between">
            <div class="flex flex-col gap-3 text-gray-600">
                <h2 class="text-xl font-semibold">Sampah Daur Ulang</h2>
                <p class="text-2xl font-bold">{{ number_format($totalBeratDaurUlang, 2, ',', '.') }} Kg</p>
            </div>
            <div class="w-fit h-fit p-2 rounded-full bg-green-400">
                <svg class="w-8 h-8 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                    stroke="currentColor">
    ...
    <div class="flex">
        <!-- Grafik Penjualan -->
        <div class="w-3/5 mt-5 ml-10 mr-2 bg-white p-6 rounded-lg shadow-lg">
            <h2 class="text-xl font-semibold mb-4">Grafik Penjualan Sampah</h2>
        ...
        <!-- Nasabah Terbaru -->
        <div class="w-2/5 mt-5 mr-10 ml-3 bg-white p-6 rounded-lg shadow-lg">
            <h2 class="text-xl font-semibold mb-2">Nasabah Teraktif</h2>
            <ul>
                @foreach ($nasabahTerbaru as $nasabah)
                    <li class="flex items-center mb-4 p-2 border-b-[3px] border-gray-300">
                        ...
                        <div>
                            <p class="text-lg font-semibold">{{ $nasabah->nama }}</p>
                            <p class="text-sm text-gray-600">{{ $nasabah->email }}</p>
                        </div>
                    </li>
                @endforeach
            </ul>
