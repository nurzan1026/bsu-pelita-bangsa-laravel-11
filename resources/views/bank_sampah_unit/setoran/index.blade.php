    ...
    <div class="w-full">
        <div class="bg-white mt-5 h-fit mx-10 rounded-md p-5">
            <div class="flex justify-between mb-6 w-full">
                <form action="" class="flex items-center" id="search-form">
            ...
            <div>
                <table class="w-full border-collapse border border-gray-200">
                    <thead class="bg-gray-300">
                        <tr>
                            <th class="border border-gray-200 text-gray-700 px-4 py-2 text-left">No</th>
                            <th class="border border-gray-200 text-gray-700 px-4 py-2 text-left">Tanggal Setor</th>
                            <th class="border border-gray-200 text-gray-700 px-4 py-2 text-left">Nasabah</th>
                            <th class="border border-gray-200 text-gray-700 px-4 py-2 text-left">Jumlah Setoran</th>
                            <th class="border border-gray-200 text-gray-700 px-4 py-2 text-left">Aksi</th>
                        </tr>
                    </thead>
                    <tbody id="setoran-table-body">
                        @foreach ($setoran as $index => $item)
                            <tr class="hover:bg-gray-100">
                                ...
                                <td class="border border-gray-200 px-4 py-2">{{ $item->detailSetoran->sum('berat') }} kg
                                </td>
