...
<head>
    ...
    <title>Register - Bank Sampah Pusat</title>
        ...
        <div class="w-full max-w-md mx-auto bg-white p-8 border border-gray-300 rounded-lg">
            ...
            <form method="POST" action="{{ route('register.submit') }}">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="phone_number" id="phone_number" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="{{ old('phone_number') }}" required>
                    @error('phone_number')
                        <span class="text-red-500 text-sm">{{ $message }}</span>
                    @enderror
                </div>
